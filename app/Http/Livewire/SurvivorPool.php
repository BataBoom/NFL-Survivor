...
class SurvivorPool extends Component
{
    ...
    {
        $pickedTeams = $this->user->survive()->where('pool', $this->mypool)->pluck('selection_id')->toArray();
    ...
    $picked = $this->user->mySurvivorPicks()->where('pool', $this->mypool)->whereNotNull('result')->pluck('selection_id')->toArray();
...
*/
    public function weeklyPicks()
    {
        ...
        $picked = $this->user->mySurvivorPicks()->where('pool', $this->mypool)->get();
        if ($picked->count() > 0) {
        return $picked;
        } else {
        return [];
    ...
    public function deleteablePicks() {
        ...
        return $this->user->mySurvivorPicks()->where('pool', $this->mypool)->whereNull('result')->get();
    }
    ...
    ['start' => '2023-09-13', 'end' => '2023-09-18'],
    ['start' => '2023-09-19', 'end' => '2023-09-25'],
    ['start' => '2023-09-26', 'end' => '2023-10-02'],
    ['start' => '2023-10-03', 'end' => '2023-10-09'],
    ['start' => '2023-10-10', 'end' => '2023-10-16'],
    ['start' => '2023-10-17', 'end' => '2023-10-21'],
    ['start' => '2023-10-22', 'end' => '2023-10-28'],
    ['start' => '2023-10-29', 'end' => '2023-11-06'],
    ...
    public function playerCount() {
        ...
        $playerCount = ['Alive'=> SurvivorLog::Where('alive', 1)->where('pool_id', $this->mypool)->count(), 'Dead' => SurvivorLog::Where('alive', 0)->where('pool_id', $this->mypool)->count()];
